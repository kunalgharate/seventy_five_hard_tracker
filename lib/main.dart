...
void main() async {
  ...
  // Register all Hive type adapters (generated by hive_generator).
  // Guards prevent duplicate registration on hot restart.
  if (!Hive.isAdapterRegistered(ChallengeAdapter().typeId)) {
    Hive.registerAdapter(ChallengeAdapter());
  }
  if (!Hive.isAdapterRegistered(DailyProgressAdapter().typeId)) {
    Hive.registerAdapter(DailyProgressAdapter());
  }
  if (!Hive.isAdapterRegistered(ChallengeSessionAdapter().typeId)) {
    Hive.registerAdapter(ChallengeSessionAdapter());
  }
  if (!Hive.isAdapterRegistered(RegularTaskAdapter().typeId)) {
    Hive.registerAdapter(RegularTaskAdapter());
  }
  if (!Hive.isAdapterRegistered(RegularTaskCompletionAdapter().typeId)) {
