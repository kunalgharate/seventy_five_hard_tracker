...
import '../bloc/accountability_event.dart';
import '../bloc/accountability_state.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const _SectionHeader(title: 'Weekly Consistency', icon: Icons.calendar_today),
        const SizedBox(height: 8),
        _WeeklyConsistencyCard(),
        const SizedBox(height: 20),
        if (accepted.isNotEmpty) ...[
          const _SectionHeader(title: 'Partner Activity', icon: Icons.people_outline),
          const SizedBox(height: 8),
